...
torus = prismaticPath' (stereoCircles' 3) 60 0.1 False
...
--  mapM_ (drawCylinder 0.25) (take 3 $ stereoCirclesDupli' 3)
  ...
  where
    drawQuad ((v1,v2,v3,v4),n) = do
      ...
      vertex v4
    --
    drawCylinder :: GLdouble -> [Vertex3 GLdouble] -> IO ()
    drawCylinder radius v1v2 = do
      let cylinder = prism (v1v2!!0) (v1v2!!1) 60 radius
      renderPrimitive Quads $ do
...
main = do
  ...
  _ <- createWindow "Bianki-Pinkall Torus"
