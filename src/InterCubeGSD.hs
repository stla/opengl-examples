...
grey1,grey9,purple,white,black,gold,green :: Color4 GLfloat
...
main = do
  ...
  _ <- createWindow "Intersection Cube GSD"
  ...
  position (Light 1) $= Vertex4 0 0 0 1
  ambient (Light 1) $= green
