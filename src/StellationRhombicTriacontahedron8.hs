module StellationRhombicTriacontahedron8
  where
...
import           StellationsRhombicTriacontahedron.Data8
import           Text.Printf
...
main = do
  ...
  _ <- createWindow "Stellated rhombic triacontahedron"
